...
namespace RockWeb.Blocks.Tv
{
    ...
    */
    [DisplayName( "Roku TV Page List" )]
    [Category( "TV > TV Apps" )]
    [Description( "Lists pages for a Roku App." )]

    #region Block Attributes
    [LinkedPage( "Page Detail", "", true, "", "", 0, AttributeKey.PageDetail )]
    #endregion Block Attributes

    [Rock.SystemGuid.BlockTypeGuid( "A67DF104-7F60-43BD-8F01-9B9E1AD0AEDC" )]
    public partial class RokuTvPageList : Rock.Web.UI.RockBlock, ISecondaryBlock
    {
