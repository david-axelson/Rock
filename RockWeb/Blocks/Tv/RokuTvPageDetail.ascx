<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RokuTvPageDetail.ascx.cs" Inherits="RockWeb.Blocks.Tv.RokuTvPageDetail" %>
        ...
        <asp:Panel ID="pnlBlock" runat="server" CssClass="panel panel-block">
            ...
            <div class="panel-body">
                ...
                <asp:Panel ID="pnlEdit" runat="server" >
                    ...
                    <Rock:CodeEditor ID="ceScenegraph" runat="server" EditorHeight="600" Label="Roku Scenegraph" />
