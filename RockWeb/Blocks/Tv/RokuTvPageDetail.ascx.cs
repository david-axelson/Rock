...
{
    /// <summary>
    /// Detail block used for a Roku page.
    /// </summary>
    [DisplayName( "Roku TV Page Detail" )]
    [Category( "TV > TV Apps" )]
    [Description( "Allows a person to edit an Apple TV page." )]

    [Rock.SystemGuid.BlockTypeGuid( "15BEC5EB-1B2E-4B22-930E-C30AD62D3B27" )]
    public partial class RokuTvPageDetail : Rock.Web.UI.RockBlock
    {
        #region Page Parameter Keys

        /// <summary>
        /// The page parameter keys for these blocks.
        /// </summary>
        private static class PageParameterKey
        {
            /// <summary>
            /// Gets or sets the site id of this page detail.
            /// </summary>
            public const string SiteId = "SiteId";

            /// <summary>
            /// Gets or sets the site page id for this site.
            /// </summary>
