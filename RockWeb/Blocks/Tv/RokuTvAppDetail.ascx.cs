...
{
    /// <summary>
    /// The Roku TV Application Detail block, used to create
    /// or manage a Rock RMS Roku App.
    /// </summary>
    [DisplayName( "Roku TV Application Detail" )]
    [Category( "TV > TV Apps" )]
    [Description( "Allows a person to edit a Roku TV application." )]

    [Rock.SystemGuid.BlockTypeGuid( "43CA4CE1-D96C-407A-B84F-B7CE6C5A40E3" )]
    public partial class RokuTvAppDetail : Rock.Web.UI.RockBlock
    {
        #region Page Parameter Keys

        /// <summary>
        /// Thg ID of this Roku application site.
        /// </summary>
        ...
        protected void btnSave_Click( object sender, EventArgs e )
        {
            ...
            var additionalSettings = new RokuTvApplicationSettings();
            var isNewSite = false;
            ...
            {
                additionalSettings = JsonConvert.DeserializeObject<RokuTvApplicationSettings>( site.AdditionalSettings );
            }
