...
export const ConfigurationComponent = defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const maybeUpdateModelValue = (): boolean => {
            ...
            newValue[ConfigurationValueKey.ShorteningSitesOnly] = asTrueFalseOrNull(shorteningSitesOnly.value) ?? "False";

            // Compare the new value and the old value.
            const anyValueChanged = newValue[ConfigurationValueKey.ShorteningSitesOnly] !== (props.modelValue[ConfigurationValueKey.ShorteningSitesOnly] ?? "False");
        ...
        watch(shorteningSitesOnly, () => maybeUpdateConfiguration(ConfigurationValueKey.ShorteningSitesOnly, asTrueFalseOrNull(shorteningSitesOnly.value) ?? "False"));
