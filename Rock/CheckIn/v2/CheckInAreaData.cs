...
namespace Rock.CheckIn.v2
{
    ...
    /// </remarks>
    internal class CheckInAreaData
    {
        #region Properties
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckInAreaData"/> class.
        /// </summary>
        /// <param name="groupTypeCache">The group cache.</param>
        /// <param name="rockContext">The rock context.</param>
        internal CheckInAreaData( GroupTypeCache groupTypeCache, RockContext rockContext )
        {
