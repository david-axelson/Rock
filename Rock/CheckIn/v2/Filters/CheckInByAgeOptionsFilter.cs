...
namespace Rock.CheckIn.v2.Filters
{
    ...
    internal class CheckInByAgeOptionsFilter : CheckInPersonOptionsFilter
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckInByAgeOptionsFilter"/> class.
        /// </summary>
        public CheckInByAgeOptionsFilter()
        {
        ...
        public override bool IsGroupValid( CheckInGroupItem group )
        {
            ...
            // If both age range and birthdate range are indeterminate, then
            // consider it a match.
